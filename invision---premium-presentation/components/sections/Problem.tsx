...
const Problem: React.FC = () => {
  return (
    <SectionWrapper className="bg-[#050505] relative overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-12 items-center w-full h-full">
        ...
        <div className="md:col-span-5 relative">
          <motion.div
            ...
            className="bg-[#111] border border-white/10 p-8 md:p-12 relative overflow-hidden shadow-2xl"
          >
            {/* Orange Warning Line */}
